...
public class TeacherDatabaseManager_N {
	private Teacher_N[] datas;
	
	// 테스트용 초기 데이터 나중에는 삭제할 것임.
	{
		datas = new Teacher_N[2];
		datas[0] = new Teacher_N("고명환", "1234");
		datas[0].setLoginDate(new Date());
		datas[1] = new Teacher_N("김수덕", "1111");
	}
	
	public Teacher_N login(String name, String password) {
	...
	public Teacher_N getTeacher(String name) {
