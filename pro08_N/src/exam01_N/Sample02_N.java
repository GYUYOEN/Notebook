...
//		System.out.print(Arrays.toString(sArr));
		System.out.print(String.join(",", sArr));
	}
...
//		System.out.println("전화번호 입력을 확인하였습니다.");
	...
	public void ex04() {
		...
		while(true) {
			...
			if(email[1].equals(emailDomain[0]) || email[1].equals(emailDomain[1]) || email[1].equals(emailDomain[2])) {
...
//		}
	...
	public static void main(String[] args) {
		Sample02_N sample = new Sample02_N();
		sample.ex01();
//		sample.ex02();
//		sample.ex03();
//		sample.ex04();
