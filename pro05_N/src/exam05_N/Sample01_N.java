...
public class Sample01_N {
	...
	public static void main(String[] args) {
		 ...
		 */
		Circle_N c1 = new Circle_N();
		Circle_N c2 = new Circle_N();
 		
 		c1.radius  = 1.5;	c2.radius = 3.5;
 		c1.diamiter = 2 * c1.radius;
 		c2.diamiter = 2 * c2.radius;
 		
 		c1.area = c1.PI * c1.radius * c1.radius;
 		c2.area = c2.PI * c2.radius * c2.radius;
 		...
 		Rectangle_N r1 = new Rectangle_N();
 		Rectangle_N r2 = new Rectangle_N();
